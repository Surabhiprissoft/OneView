...
public interface APIInterface {
    ...
    Call<ValidateCaptchaResponseModel> ValidateCaptcha(@Body ValidateCaptchaRequestModel validateCaptchaRequestModel);

    @POST(Constants.LOGINWITHOTP)
    Call<String> loginUserWithOtp(@Body String loginWithOtpRequestModel);
    ...
    Call<InrCardStatementResponseModel> getCardStatement(@Body InrCardStatementRequestModel inrCardStatementRequestModel);
    ...
    Call<SetPinResponseModel> getSetPin(@Body SetPinRequestModel setPinRequestModel);
